          ...
          <div className="bg-card rounded-lg shadow-lg border border-border overflow-hidden">
            ...
            <div className="p-8">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="font-semibold text-card-foreground">{event.location}</p>
                    </div>
                  </div>
                </div>
                  ...
                  {event.capacity && (
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="font-semibold text-card-foreground">{event.capacity} attendees</p>
                      </div>
                    </div>
                  )}
                  ...
                  {event.price && (
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="font-semibold text-card-foreground">{event.price}</p>
                      </div>
                    </div>
                  )}
                  ...
                  {event.isVirtual && (
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="font-semibold text-card-foreground">Virtual Event</p>
                      </div>
                    </div>
                  )}
                </div>
              ...
              {event.organizers && event.organizers.length > 0 && (
                <div className="mb-8">
                  <h3 className="text-lg font-semibold text-card-foreground mb-3">Organizers</h3>
                  <div className="flex flex-wrap gap-2">
              ...
              {event.sponsors && event.sponsors.length > 0 && (
                <div className="mb-8">
                  <h3 className="text-lg font-semibold text-card-foreground mb-3">Event Sponsors</h3>
