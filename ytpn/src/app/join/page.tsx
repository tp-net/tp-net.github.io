            ...
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    <div className="font-medium text-foreground">Exclusive Networking Events</div>
                    <div className="text-sm text-foreground-secondary">Connect with industry leaders and peers</div>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  <div className="w-2 h-2 bg-primary rounded-full mt-2 flex-shrink-0"></div>
                  <div>
                    <div className="font-medium text-foreground">Professional Development</div>
                    <div className="text-sm text-foreground-secondary">Workshops, talks, and skill-building sessions</div>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  <div className="w-2 h-2 bg-primary rounded-full mt-2 flex-shrink-0"></div>
                  <div>
                    ...
                    <div className="text-sm text-foreground-secondary">Access to job postings and mentorship programs</div>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  <div className="w-2 h-2 bg-primary rounded-full mt-2 flex-shrink-0"></div>
                  <div>
                    <div className="font-medium text-foreground">Community Support</div>
                    <div className="text-sm text-foreground-secondary">24/7 access to our vibrant online community</div>
                  </div>
                </div>
              </div>
            </div>
