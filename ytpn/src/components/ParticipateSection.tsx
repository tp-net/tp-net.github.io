...
const services = [
  {
    ...
    description:
      'Connect with early-career engineers, scientists, developers, and analysts building the future of technical practice. Be part of a cross-disciplinary community from day one.',
    icon: '🛠️',
    ctaText: 'Join Now',
  ...
  },
  {
    ...
    description:
      'Explore real projects, fresh ideas, and lessons from across industries. Each Showcase or Expo is a chance to meet peers and learn something new.',
    icon: '⚙️',
    ctaText: 'View Events',
  ...
  },
  {
    ...
    description:
      'Represent your company, university, or association. Co-host an event or bring your members into the network to share knowledge and experience.',
    icon: '🤝',
  ...
  },
  {
    ...
    description:
      'Support an independent initiative that connects emerging technical talent. Help us keep events accessible and foster the next generation of professionals.',
    icon: '💡',
  ...
  },
  {
    ...
    description:
      'Know someone with an idea worth sharing? Nominate a speaker or suggest a topic that bridges disciplines and sparks conversation.',
    icon: '🎤',
      ...
      <div className='container mx-auto px-6'>
        <div className='text-center mb-16'>
          ...
          <p className='text-lg text-foreground-secondary max-w-2xl mx-auto'>
            ...
            share your expertise, there's a way for you to make a difference in
            the technical professional landscape.
          </p>
        </div>
